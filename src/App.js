  ...
  render() {
    return (
      <Container className="App">
        ...
        <br />
        <h3>Solution to question 1 <img src= "OneWayToRoundTrip.png" alt= "GraphOne" /> </h3>
        <h3> <img src= "PassHolderType.png" alt = "GraphTwo" /></h3>
        <h3><img src= "StartingStation.png" alt = "GraphThree"></img></h3>
        <br />
